package com.example.fleischii.einkaufslistedatenbank;
...
public class MainActivitiy extends AppCompatActivity{
  ...
  //  public static final String LOG_TAG = MainActivitiy.class.getSimpleName();
    ...
    public boolean onCreateOptionsMenu(Menu menu){
     /*Aufbau des Menüs, fügt der Aktionbar Elemente
    ...
    public boolean onOptionsItemSelected(MenuItem item){
     /* Die Aktionsleiste verarbeitet automatisch Klicks
     auf die Home / Up-Taste, solange Sie eine übergeordnete
     Aktivität in AndroidManifest.xml angeben.*/
